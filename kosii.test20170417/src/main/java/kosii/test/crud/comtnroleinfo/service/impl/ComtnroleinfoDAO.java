...
public class ComtnroleinfoDAO extends EgovComAbstractDAO {
	 ...
	 * 
	 * @param vo
	 *            - 조회할 정보가 담긴 ComtnroleinfoVO
	 * @return 조회한 COMTNROLEINFO
	 * @exception Exception
	 */
	public ComtnroleinfoVO selectComtnroleinfo(ComtnroleinfoVO vo)
			throws Exception {
		return (ComtnroleinfoVO) select(
				"comtnroleinfoDAO.selectComtnroleinfo_S", vo);
	}
	 ...
	 * @exception Exception
	 */
	public List<?> selectComtnroleinfoList(ComtnroleinfoDefaultVO searchVO)
			throws Exception {
	...
	public int selectComtnroleinfoListTotCnt(ComtnroleinfoDefaultVO searchVO) {
		return (Integer) select(
				"comtnroleinfoDAO.selectComtnroleinfoListTotCnt_S", searchVO);
	}
