	...
	if (varParam.sDate) {
		...
		if(sDate.length == 10) {
			if(pForm.init.value != "OK") {
				pForm.init.value  = "OK";
				varForm.action      = "<c:url value='/com/sym/cal/EgovselectAdministCalendar.do'/>";
...
<form name="Form" action ="<c:url value='/com/sym/cal/EgovselectAdministCalendar.do'/>" method="post">
