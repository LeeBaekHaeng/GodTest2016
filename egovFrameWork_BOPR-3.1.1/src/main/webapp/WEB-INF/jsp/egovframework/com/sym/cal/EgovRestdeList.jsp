...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/com/sym/cal/EgovRestdeList.do'/>";
...
function fn_egov_regist_Restde(){
	location.href = "<c:url value='/com/sym/cal/EgovRestdeRegist.do' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_Restde(restdeNo){
	...
	varForm.action           = "<c:url value='/com/sym/cal/EgovRestdeDetail.do'/>";
...
<form name="listForm" action="<c:url value='/com/sym/cal/EgovRestdeList.do'/>" method="post">
