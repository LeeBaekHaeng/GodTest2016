...
function fnChangeCalendar(year, month){
	...
	varForm.action      = "<c:url value='/com/sym/cal/EgovAdministMonthCalendar.do'/>";
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="administMonthCalendar" action ="<c:url value='/com/sym/cal/EgovAdministMonthCalendar.do'/>" method="post">
