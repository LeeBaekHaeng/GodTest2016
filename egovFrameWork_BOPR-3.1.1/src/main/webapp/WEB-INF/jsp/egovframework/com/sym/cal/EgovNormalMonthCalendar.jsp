...
function fnChangeCalendar(year, month){
	...
	varForm.action      = "<c:url value='/com/sym/cal/EgovNormalMonthCalendar.do'/>";
...
<DIV id="content">
<!-- ------------------------------------------------------------------ 상단타이틀 -->
<form name="normalMonthCalendar" action ="<c:url value='/com/sym/cal/EgovNormalMonthCalendar.do'/>" method="post">
