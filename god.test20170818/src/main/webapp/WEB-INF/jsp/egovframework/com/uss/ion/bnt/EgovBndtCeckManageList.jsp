...
<!-- ********** 여기서 부터 본문 내용 *************** -->
	...
	<input type="hidden" name="pageIndex" value="<c:if test="${empty bndtCeckManageVO.pageIndex }">1</c:if><c:if test="${!empty bndtCeckManageVO.pageIndex }"><c:out value='${bndtCeckManageVO.pageIndex}'/></c:if>">
		...
		<table width="700" cellpadding="8" class="table-search" border="0">
		 <tr>
		  <td width="40%"class="title_left">
		   <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;당직체크관리 목록</h1></td>
		  <th>
		  </th>
		  <td width="10%"></td>
		  <td width="35%"></td>
		...
		<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="당직체크관리 검색조건" >
		  ...
		  <tr>
		    <th width="20%" height="23" class="required_text"  scope="row"><label for="searchBndtCeckSe">당직구분</label><img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>          
		    <td width="30%"  >
		    ...
		    <th width="20%" height="23" class="required_text"  scope="row"><label for="searchKeyword">당직체크코드명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>          
		    <td width="30%" nowrap >
		    	    <input name="searchKeyword" type="text" size="20" value="${bndtCeckManageVO.searchKeyword}"  maxlength="100" title="당직체크코드명"> 
	        </td>
		  </tr> 
		  <tr>
		    <th width="20%" height="23" class="required_text"  scope="row"><label for="searchUseAt">사용여부</label><img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>          
