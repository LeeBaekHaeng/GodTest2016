package kosii.test.sub.comtnemplyrinfo.service;
...
public interface ComtnemplyrinfoService {
	 ...
	 * @exception Exception
	 */
	ComtnemplyrinfoVO selectComtnemplyrinfo(ComtnemplyrinfoVO vo)
			throws Exception;
	 ...
	 * @exception Exception
	 */
	List selectComtnemplyrinfoList(ComtnemplyrinfoDefaultVO searchVO)
			throws Exception;
