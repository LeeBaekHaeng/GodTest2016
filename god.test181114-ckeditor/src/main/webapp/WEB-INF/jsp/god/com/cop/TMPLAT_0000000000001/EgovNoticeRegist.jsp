...
<!-- 	      <textarea id="nttCn" name="nttCn" class="textarea" cols="75" rows="28" style="width:550px;" title="내용입력"></textarea> -->
	  ...
	  <tr>
	    ...
	    <td colspan="3">
	     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="noStyle">
	     <tr><td>
<!-- 	      <textarea id="nttCn2" name="nttCn2" class="textarea" cols="75" rows="28" style="width:550px;" title="내용입력"></textarea> -->
<%-- 	      <form:errors path="nttCn" /> --%>
	      </td></tr>
	     </table>
	    </td>
	  ...
	  <tr>
	    ...
	    <td colspan="3">
	     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="noStyle">
	     <tr><td>
<!-- 	      <textarea id="nttCn3" name="nttCn3" class="textarea" cols="75" rows="28" style="width:550px;" title="내용입력"></textarea> -->
<%-- 	      <form:errors path="nttCn" /> --%>
	      </td></tr>
	     </table>
	    </td>
...
<textarea id="nttCn" name="nttCn" style="width: 100%; height: 2000px;"></textarea>
<textarea id="nttCn2" name="nttCn2" style="width: 100%; height: 1000px;"></textarea>
<textarea id="nttCn3" name="nttCn3" style="width: 100%; height: 1000px;"></textarea>
...
// 	$.get('${pageContext.request.contextPath}/test/1.htm', {}, function(data) {
	$.get('${pageContext.request.contextPath}/test/ed_request.html', {}, function(data) {
        ...
        ClassicEditor
        .create( document.querySelector( '#nttCn' ) )
        .catch( error => {
            console.error( error );
        } );
	...
	$.get('${pageContext.request.contextPath}/test/2.htm', {}, function(data) {
        ...
        ClassicEditor
        .create( document.querySelector( '#nttCn2' ) )
        .catch( error => {
            console.error( error );
        } );

	}, 'html');
	$.get('${pageContext.request.contextPath}/test/3.htm', {}, function(data) {
		$('#nttCn3').val(data);

        ClassicEditor
        .create( document.querySelector( '#nttCn3' ) )
        .catch( error => {
            console.error( error );
        } );
