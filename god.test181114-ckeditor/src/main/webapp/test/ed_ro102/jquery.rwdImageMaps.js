...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MzQxNTg5OTE4OjAwMjBiYzI5OTQ3YzYyZTQxYWE5MmM0NGRlMDc5OWFkNTljMDgzZWNjNzM1YzIzNzgzZGQ3ZWE3N2FmYjQzMmU=--a6fffcd0155323514bf44d844079f724278efffa">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="E6AE:63DB:10C8429:19C1F22:5BF1492F" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="E6AE:63DB:10C8429:19C1F22:5BF1492F" /><meta name="octolytics-dimension-region_edge" content="sea" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="45113431" /><meta name="octolytics-actor-login" content="god18" /><meta name="octolytics-actor-hash" content="5cb66b1a8f834493cf04dd3c9f516dafbf0db67b08efc6c4b6e67fd1c57760db" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="userId" content="01f75c9473bcbe7fde0cc5b7b459291a" %>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="god18">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="3c6de49456d1107f266b20be6562e082667e00cf">
...
>
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="4030134" data-scoped-search-url="/stowball/jQuery-rwdImageMaps/search" data-unscoped-search-url="/search" action="/stowball/jQuery-rwdImageMaps/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search or jump to…"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=cNeAFJu9W4ELQVWy811HRk75U2zTLMSLSJZDYJr3OqNouyPPorgvzbyrmBD7BhsetnLJ+DXBM0UI+bkgb79MwA=="
          spellcheck="false"
          autocomplete="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:unread" data-channel="notification-changed:45113431" href="/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    ...
    <a role="menuitem" class="dropdown-item" href="/stowball/jQuery-rwdImageMaps/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@god18" class="avatar float-left mr-1" src="https://avatars0.githubusercontent.com/u/45113431?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          <li class="header-nav-current-user css-truncate"><a role="menuitem" class="no-underline user-profile-link px-3 pt-2 pb-2 mb-n2 mt-n1 d-block" href="/god18" data-ga-click="Header, go to profile, text:Signed in as">Signed in as <strong class="css-truncate-target">god18</strong></a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="/god18" data-ga-click="Header, go to profile, text:your profile">Your profile</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/god18?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a></li>


          <li><a role="menuitem" class="dropdown-item" href="/god18?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a></li>
            <li><a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, your gists, text:your gists">Your gists</a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">Help</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/settings/profile" data-ga-click="Header, go to settings, icon:settings">Settings</a></li>
          <li>
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="kGk3vuWIDw+exLz2qlf8qq5GwqHXjGSBjqQmWM5kNEUQWTLWpinNzttRWB5TlfoDu9rw3Nukq+i47+1WAowo9Q==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="0rrFoNLR4JoDamjbPLK16eZAC5dd1+0WNr6a31FNi+JSisDIkXAiW0b/jDPFcLNA89w56lH/In8A9VHRnaWXUg==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-remote="true" class="js-social-form js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="lqQfTKfC4+OvCUe9Gl6FA+d4ocK2wzhzkaR1zlwTQ9DivHNSHFF3rhD5UR26Q3Wdr3CziX4LDYUReZ5ZgAn3iA==" />      <input type="hidden" name="repository_id" id="repository_id" value="4030134" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/stowball/jQuery-rwdImageMaps/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="COjQIxvUzCUatFr7mJlQI/N3ls3bpl0FTnSNb16NbADFdV9VCpXQpBrD2qkwRYaIznDIRA/ss5YYra18oXjDzg==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/stowball/jQuery-rwdImageMaps/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="DNkiQs+AzKWHj+sVIIZJrm5MbZT6egfainOUuDQ9eleparX5GK8wbvIgrheoROmseDtDDe4ROONLQGB4gRpMhA==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/stowball/jQuery-rwdImageMaps/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="cS3T00KbXGmrE6hjAeu2sUkvNLX2CfQlYz/+nbWozu3jwnQJCsjimdZjJCT3pBsVV3qeUZmyD2vKFQALXaZBaA==" />
            <button
                type="submit"
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /stowball/jQuery-rwdImageMaps/wiki" href="/stowball/jQuery-rwdImageMaps/wiki">
      <svg class="octicon octicon-book" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"/></svg>
      Wiki
</a>
  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts /stowball/jQuery-rwdImageMaps/pulse" href="/stowball/jQuery-rwdImageMaps/pulse">
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div class="select-menu-modal">
      ...
      <div id="blob-path" class="breadcrumb">
        <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/stowball/jQuery-rwdImageMaps"><span>jQuery-rwdImageMaps</span></a></span></span><span class="separator">/</span><strong class="final-path">jquery.rwdImageMaps.js</strong>
      </div>
    </div>
  ...
  <div class="commit-tease">
      ...
      <div>
        ...
        <a class="user-mention" rel="author" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=853552" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/stowball">stowball</a>
          <a data-pjax="true" title="Added support for jQuery 3. Dropped &lt;1.7. Fixes #103" class="message" href="/stowball/jQuery-rwdImageMaps/commit/ded8104752d01c8e9cdc1438993ec8037a0effef">Added support for jQuery 3. Dropped &lt;1.7.</a> <span aria-label="This commit closes issue #103." class="issue-keyword tooltipped tooltipped-se"><a data-pjax="true" title="Added support for jQuery 3. Dropped &lt;1.7. Fixes #103" class="message" href="/stowball/jQuery-rwdImageMaps/commit/ded8104752d01c8e9cdc1438993ec8037a0effef">Fixes</a></span> <a href="https://github.com/stowball/jQuery-rwdImageMaps/issues/103" class="issue-link js-issue-link" data-error-text="Failed to load issue title" data-id="166893333" data-permission-text="Issue title is private" data-url="https://github.com/stowball/jQuery-rwdImageMaps/issues/103">#103</a>
      </div>
...
<details class="details-reset details-overlay details-overlay-dark lh-default text-gray-dark float-left mr-2" id="blob_contributors_box">
  ...
  <details-dialog class="Box Box--overlay d-flex flex-column anim-fade-in fast " aria-label="Users who have contributed to this file">
    <div class="Box-header">
        ...
        <ul class="list-style-none overflow-auto">
            <li class="Box-row">
              <a class="link-gray-dark no-underline" href="/stowball">
                <img class="avatar mr-2" alt="" src="https://avatars0.githubusercontent.com/u/853552?s=40&amp;v=4" width="20" height="20" />
                stowball
</a>            </li>
            <li class="Box-row">
      ...
      <img class="avatar" src="https://avatars0.githubusercontent.com/u/853552?s=40&amp;v=4" width="20" height="20" alt="@stowball" /> 
    ...
    <div class="BtnGroup">
      ...
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/stowball/jQuery-rwdImageMaps/commits/master/jquery.rwdImageMaps.js">History</a>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/stowball/jQuery-rwdImageMaps/edit/master/jquery.rwdImageMaps.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="vYBlPqVssoSsa6FLNb4xAMIT99ktGvkxBV3KhGwsjZAbRNSdoAE4FNMwTIzBpA5mmIVFT57XoBtmzEQFYHaXEw==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/stowball/jQuery-rwdImageMaps/delete/master/jquery.rwdImageMaps.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Fq8Z1DiyAAvueSpTTp5E0kWgr878mJ3N3k5DzyYLP6FAFAZ/4Y/JHa53T9RbhRqZaDsMA284gd0URb9g2PpcMg==" />
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/stowball/jQuery-rwdImageMaps/blame/afc88d07bc9b81c0418a69207d51ed6f0ddcc0b2/jquery.rwdImageMaps.js">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" role="menuitem" href="/stowball/jQuery-rwdImageMaps/issues/new">Open new issue</a></li>
      </ul>
    </details-menu>
  </details>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.21788s from unicorn-84bfb88bb4-fnqd6">GitHub</span>, Inc.</li>
