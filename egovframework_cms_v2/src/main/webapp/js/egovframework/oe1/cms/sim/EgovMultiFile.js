...
function MultiSelector( list_target, max ){
	...
	this.addElement = function( element ){
		...
		if( element.tagName == 'INPUT' && element.type == 'file' ){
			...
			element.onchange = function(){
				...
				new_element.setAttribute("className", "ser_box");
				new_element.setAttribute("class", "ser_box");
	...
	this.addListRow = function( element ){
		...
		new_span_element.setAttribute("className", "button");
		new_span_element.setAttribute("class", "button");
		
		var new_row_button = document.createElement( 'input' );
		new_row_button.type = 'button';
		new_row_button.value = '삭제';
		
		new_span_element.appendChild(new_row_button);
		...
		new_row.appendChild( new_span_element );
