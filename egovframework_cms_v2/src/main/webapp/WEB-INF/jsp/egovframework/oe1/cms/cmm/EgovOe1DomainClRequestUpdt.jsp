...
<%
/**
 * @JSP Name : EgovOe1DomainClRequestUpdt.jsp
 * @Description : 도메인분류신청수정
...
<validator:javascript formName="domainClassRequestInfo" staticJavascript="false" xhtml="true" cdata="false"/>
...
function fn_egov_list(){
	var varForm				 = document.getElementById("domainClassRequestInfo");
...
function fn_egov_save(cmd){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		if(!validateDomainClassRequestInfo(varForm)){ 			
			return;
		}else{
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="domainClassRequestInfo" name="domainClassRequestInfo" action="${pageContext.request.contextPath}/cms/metadata/req/updateDomainClRequestInfo.do" method="post" >
			<input name="cmd"            type="hidden" value="<c:out value='save'/>"/>
			<form:hidden path="reqstProcessId"/>
			<form:hidden path="reqstProcessSn"/>
			<form:hidden path="applcntId"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>도메인분류신청수정</strong></h1></div>
				
				<div id="datail_table">
				<table summary="도메인분류ID,도메인분류명,사용여부">
					<caption>도메인분류신청수정</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
					...
					<tr>
						...
						<td>
							<c:out value="${domainClassRequestInfo.reqstProcessId}"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="reqstProcessSn">신청처리순번</label></th>
						<td>
							<c:out value="${domainClassRequestInfo.reqstProcessSn}"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="applcntId">신청인</label></th>
						<td>
							<c:out value="${domainClassRequestInfo.applcntNm}"/>
						</td>
					</tr>
					<tr>
