...
<%
  /**
  * @JSP Name : EgovSanctnSmtOpinionPopup.jsp
  * @Description : 상신의견작성
...
function fn_egov_ok() {
	...
	if(confirm("상신하시겠습니까?")){
		window.opener.document.detailForm.drftOpinion.value = thisForm.drftOpinion.value;
		window.opener.fn_egov_doSubmit();
		window.close();
	}
}
</script>
...
<div id="wrap">
    <div id="container">
		<div id="content">
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>결재상신의견</strong></h1></div>

						<form:form commandName="sanctionSubmitVO" name="detailForm" method="post">
						<div id="datail_table">		
							<table width="410" border="0" cellspacing="0" cellpadding="0">
									<tr>
										  <th>상신의견</th>
								  				  <td align="left" style="padding-right:5px; padding-left:5px;">
								  				  <textarea id="drftOpinion" name = "drftOpinion"  wrap="hard" onkeyup="contents_check(this, 200);" onkeypress="contents_check2()" rows="5" cols="80" cssStyle="width:600px;ime-mode:active" title="상신의견"></textarea>
								  				  <form:errors path="drftOpinion" />
								  				  </td>
								  	</tr>
							</table>						
						</div>
						...
						<ul>
						    ...
						    <li><span class="submit_btn01"><input type="submit" name="submit_btn" value="상신" class="submit_btn_input"  onclick="javascript:fn_egov_ok(); return false;" /></span></li>
