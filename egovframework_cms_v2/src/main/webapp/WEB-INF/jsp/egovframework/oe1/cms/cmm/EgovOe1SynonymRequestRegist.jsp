...
<%
/**
 * @JSP Name : EgovOe1SynonymRequestRegist.jsp
 * @Description : 동의어신청등록
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="synonymRequestInfo" name="synonymRequestInfo" action="${pageContext.request.contextPath}/cms/metadata/req/insertSynonymRequestInfo.do" method="post" >
			<input name="cmd"            type="hidden" value="<c:out value='save'/>"/>
			<input name="reqstProcessId" type="hidden" value="<c:out value='AUTOINIT'/>"/>
			<form:hidden path="applcntId"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>동의어신청등록</strong></h1></div>
				
				<div id="datail_table">
				<table summary="동의어분류ID,동의어분류명,사용여부">
					<caption>동의어신청등록</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
					...
					<tr>
						<th scope="row"><span class="th_add"><label for="synonmClId">용어영문약어명</label></span></th>
						<td>
							<input type="text" id="wordEngAbrvNm" name="wordEngAbrvNm" readonly="readonly" class="inputsmall01" title="용어영문약어명"/>
							<input type="button" name="용어선택버튼" value="선택" onclick="fn_egov_worddic_call(); return false;" title="새창">
						</td>
					</tr>					
					<tr>
						<th scope="row"><span class="th_add"><label for="synonmClId">용어명</label></span></th>
						<td>
