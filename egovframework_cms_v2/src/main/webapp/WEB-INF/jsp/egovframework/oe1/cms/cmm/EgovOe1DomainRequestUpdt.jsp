...
<%
/**
 * @JSP Name : EgovOe1DomainRequestUpdt.jsp
 * @Description : 도메인신청수정
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="domainRequestInfo" name="domainRequestInfo" action="${pageContext.request.contextPath}/cms/metadata/req/updateDomainRequestInfo.do" method="post" >
			<input name="cmd" type="hidden" value="<c:out value='save'/>"/>
			<form:hidden path="reqstProcessId"/>
			<form:hidden path="reqstProcessSn"/>
			<form:hidden path="applcntId"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>도메인신청수정</strong></h1></div>
				
				<div id="datail_table">
				<table summary="도메인ID,도메인명,사용여부">
					<caption>도메인신청수정</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
					...
					<tr>
						...
						<td>
							<c:out value="${domainRequestInfo.reqstProcessId}"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="reqstProcessSn">신청처리순번</label></th>
						<td>
							<c:out value="${domainRequestInfo.reqstProcessSn}"/>
						</td>
					</tr>
					<tr>
