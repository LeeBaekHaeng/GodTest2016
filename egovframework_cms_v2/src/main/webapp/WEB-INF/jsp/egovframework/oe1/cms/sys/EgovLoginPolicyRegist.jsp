...
<%
  /**
  * @JSP Name : EgovLoginPolicyRegist.jsp
  * @Description : 로그인정책 정보 등록 화면
...
function fncLoginPolicyInsert(){
    ...
    if(confirm('<spring:message code="common.save.msg" />')){
        if(!validateLoginPolicy(frm)){           
            ...
            if(ipValidate()){
            	frm.action ="<c:url value='/cms/sys/addLoginPolicy.do'/>";
	            frm.submit();
            }else{ 
                return;
            }
...
function fn_reset(){
	document.regist_form.action="<c:url value='/cms/sys/addLoginPolicyView.do'/>";
...
<div id="wrap">
    ...
    <div id="container">
		...
		<!-- BODY 내용 START -->
						...
						<!-- 타이틀 -->
						<div id="h2_topnav">
						<h1><strong>로그인정책정보 등록</strong></h1>
						</div>
						<!-- // 타이틀 -->							
			
								<div id="datail_table">		
								
								<table summary="이 표는 로그인정책 정보 목록정보를 제공하며 사용자ID, 사용자명, IP정보, IP제한여부로 구성되어 있습니다." class="table_style">
										...
										<tr>
											<th scope="row"><span id="id_temp" class="th_add"><label for="ipInfo">IP정보</label></span></th>
											<td>
										...
										<tr>
											<th scope="row"><span class="th_add"><label for="lmttAt">IP제한여부</label></span></th>
											<td>
												<form:select path="lmttAt" cssClass="use" id="lmttAt" title="IP제한여부">
							    ...
							    <div class="subbtn_align">          
							        <ul>
							            ...
							            <li class="btn02_middlebg"><a href="<c:url value='/oe1/cms/sys/updtLoginPolicy.do'/>" onclick="fncLoginPolicyInsert(); return false;" class="btn_link">저장</a></li>
							            <li class="btn02_rightbg"></li>

								    	<li class="btn02_leftbg"></li>
							            <li class="btn02_middlebg"><a href="<c:url value='/oe1/cms/sys/selectLoginPolicyList.do'/>" onclick="selectLoginPolicyList(); return false;" class="btn_link">목록</a></li>
							            <li class="btn02_rightbg"></li>
							        </ul>
							    </div>
