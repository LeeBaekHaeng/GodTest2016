...
<%
/**
 * @JSP Name : EgovOe1SynonymHistPopup.jsp
 * @Description : 동의어이력조회팝업
...
<div id="content_pop">
	<div id="h2_topnav"><h1><strong>동의어이력상세조회</strong></h1></div>
	
	<div id="datail_table">
	<table  summary="코드ID명,코드,코드명,코드설명,사용여부   입니다.">
		<caption>동의어이력상세조회 상세조회</caption>
		<colgroup>
			<col width="150">
			<col width="">
		</colgroup>
