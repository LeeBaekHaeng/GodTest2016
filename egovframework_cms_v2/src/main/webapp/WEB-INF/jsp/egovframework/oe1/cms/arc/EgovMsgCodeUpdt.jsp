...
function fn_egov_delete() {
	if(confirm('<spring:message code="common.delete.msg" />')) {
	   	document.msgCodeManage.action = "<c:url value='/cms/arc/deleteMsgCode.do'/>";
	   	document.msgCodeManage.submit();
	}
}
...
function fn_egov_save() {	
	...
	if(!validateMsgCodeManage(frm)){
		...
		if(confirm('<spring:message code="common.save.msg" />'))  {
	    	frm.action = "<c:url value='/cms/arc/updateMsgCode.do'/>";
	        frm.submit();
		}
	}
}
...
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="h2_topnav"><h1><strong> 메시지코드 상세정보</strong></h1></div>
	<!-- // 타이틀 -->
	<div id="datail_table">
	<table summary="메시지코드 상세정보" class="table_style" id="tableId1">
	<colgroup>
		<col width="200">
		<col width="">
	</colgroup>
		...
		<tr>
			...
			<td>
				<form:input path="mssageCode" maxlength="30" cssClass="inputsmall01_readOnly" readonly="true"  title="메시지코드"/>
		...
		<tr>
			...
			<td>
				<form:input path="mssageCodeNm" maxlength="60" cssClass="inputsmall01" title="메시지코드명" />
				&nbsp;<form:errors path="mssageCodeNm" />
			</td>
		</tr>
		<tr>
			<th scope="row"><label for="mssageCodeDc">코드 설명</label></th>
			<td>
				<form:input path="mssageCodeDc" maxlength="200" cssClass="inputsmall01" title="코드 설명" />
