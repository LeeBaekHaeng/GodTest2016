...
<%
  /**
  * @JSP Name : EgovSanctnDrftUpdt.jsp
  * @Description : 결재상신수정
...
function fn_egov_doSubmit() {
   	document.detailForm.action = "<c:url value='/cms/cmm/modifySanctionDraftingWriting.do'/>";
   	document.detailForm.submit();
...
<div id="wrap">
    ...
    <div id="container">
		...
		<!-- BODY 내용 START -->
						...
						<input type="hidden" name="returnUrl" value="<c:url value='/cms/sys/updateSanctionSmtView.do'/>?drftSn=<c:out value='${sanctionSubmitVO.drftSn}'/>" />
						<input type="hidden" name="sanctnRouteId"/>
						<input type="hidden" name="sanctnRouteSeCode"/>

							<!-- content_pop 시작 -->	
							<div id="content_pop">
								<div id="h2_topnav"><h1><strong> 기안수정</strong></h1></div>
				...
				<tr>
					<th><span class="th_add">결재경로</span></th>
					<td >
				        ...
				        <ul>
				            ...
				            <li class="btn01_middlebg">
								<a href="#LINK" onclick="fn_egov_addDrafter();">선택</a>
							</li>
				...
				<tr>
					...
					<td> 
						<textarea id="drftCn" name = "drftCn" wrap="hard" onkeyup="contents_check(this, 300);" onkeypress="contents_check2()" rows="5" cols="80" cssStyle="width:600px;ime-mode:active" title="내용"><c:out value="${sanctionSubmitVO.drftCn}"/></textarea>
						<form:errors path="drftCn" />
					</td>
				</tr>					
