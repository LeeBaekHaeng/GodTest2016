...
<%
  /**
  * @JSP Name : EgovDicGovTermUpdt.jsp
  * @Description : 행정용어사전 수정 화면
...
function fn_egov_save() {	
	...
	document.dicgovtermForm.selectedId.value = frm.selectedId.value;
	
	if(!validateDicgovtermForm(frm)){
        return;
    }else{    	
        if(confirm("저장하시겠습니까?")){
    		document.dicgovtermForm.action = "<c:url value='/cms/cmm/updateDicGovTermOK.do'/>";
    		document.dicgovtermForm.submit();
        }	
    }
...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="content"><!-- BODY 내용 START -->
			...
			<form:form commandName="egovOe1DicGovTermVO" name="dicgovtermForm" action="/oe1/cms/cmm/updateDicGovTermOK.do" method="post">
			<input type="hidden" name="selectedId" value="<c:out value="${egovOe1DicGovTermVO.administWordId}"/>"/>
			<div id="content_pop">
				<!-- 타이틀 -->
				<div id="h2_topnav"><h1><strong>행정용어사전 수정</strong></h1></div>
				<!-- // 타이틀 -->
				<div id="datail_table">
				<table summary="구분,주제영역,용어명,영문명,영문약어명,용어 설명,사용여부 입니다" >
					...
					<tr>
						<th scope="row"><span class="th_add"><label for="administWordSe">사용여부</label></span></th>
						<td>
							<select name="administWordSe" id="administWordSe" tabindex="1" class="opselect_smaill01" title="구분">
							  ...
							  <option value='${codeInfo.code}' <c:if test="${egovOe1DicGovTermVO.administWordSe == codeInfo.code}">selected="selected"</c:if>>${codeInfo.codeNm}</option>
							  </c:forEach>
							</select>					
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<form:input path="administWordNm" maxlength="100" tabindex="3" cssClass="inputsmall01" title="용어명" readonly="true"/>
					...
					<tr>
						...
						<td>
							<form:input path="administWordEngNm" maxlength="100" tabindex="4" cssClass="inputsmall01" title="영문 명" readonly="true"/>
					...
					<tr>
						...
						<td>
							<form:input path="administWordAbrv" maxlength="100"  tabindex="5" cssClass="opselect_smaill01" title="영문약어명" readonly="true"/>
					...
					<tr>
						...
						<td>
						<form:textarea path="administWordDc" rows="5" cols="50" tabindex="6" cssClass="textareasmall01" title="용어 설명"/>
