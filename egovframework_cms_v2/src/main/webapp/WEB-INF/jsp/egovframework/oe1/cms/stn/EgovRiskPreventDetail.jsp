...
<%
 /**
  * @JSP Name : EgovRiskPreventDetail.jsp
  * @Description : 위험예방활동 상세조회 화면
...
function fn_egov_update_RiskManage(riskId){
	location.href = "<c:url value='/cms/stn/chrg/EgovOe1RiskManageUpdateView.do'/>?riskId=" + riskId;
}
  ...
  function fn_egov_regist_RiskManage(form){
	if(confirm("<spring:message code='common.save.msg'/>")){
		if(!validateRiskManage(form)){ 			
			...
			form.action = "<c:url value='/cms/stn/chrg/EgovOe1RiskManageRegist.do'/>"; 
			form.submit();
		}
	}
}
...
<div id="content_pop">
	<div id="h2_topnav"><h1><strong> 위험예방활동 상세조회</strong></h1></div>
	
	<div id="datail_table">
	<table summary="위험명,위험구분,위험내용,위험도,담당자,작업지시내용,첨부파일,예방활동결과,예방활동기간,예방활동내용  상세테이블 입니다">
	<caption>위험예방활동 상세 테이블</caption>
		<colgroup>
			<col width="150">
			<col width="">
		</colgroup>
	...
	<!-- 버튼 -->				
  	<div class="subbtn_align">  		
	  	<ul>
		    ...
		    <li class="btn02_middlebg"><a href="<c:url value='/cms/stn/chrg/EgovOe1RiskPreventList.do'/>" onclick="fn_egov_list_RiskPrevent(); return false;" class="btn_link">목록</a></li>
