...
<%
  /**
  * @JSP Name : EgovDicGovTermExcelRegist.jsp
  * @Description : 행정행정용어사전 엑셀 Register 화면
...
function fn_egov_save(){
    ...
    if(confirm("기존 등록된 내용이 삭제 된 후 저장됩니다. \n계속 진행 하시겠습니까?")){
    	document.dicgovtermForm.action =  "<c:url value = '/cms/cmm/addDicGovTermExcelOK.do'/>";
    	document.dicgovtermForm.submit();
    }
}
*/
	...
	if(frm.fileNm.value==""){
    	...
    	if(fnImg_Check(frm.fileNm.value)){
        	if(confirm("기존 등록된 자료를 삭제후  파일을 등록합니다. \n엑셀 일괄등록을 하시겠습니까?  \n\n시간이 오래 걸릴 수 있습니다.")){
	        	frm.action = "<c:url value='/cms/cmm/addDicGovTermExcelOK.do'/>";
	        	frm.submit();            	
        	}
    	}    	            	
    }
...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="content"><!-- BODY 내용 START -->
			...
			<form:form commandName="egovOe1DicGovTermVO" name="dicgovtermForm" action="/cms/cmm/addDicGovTermExcelOK.do" method="post" enctype="multipart/form-data" >
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong> 행정용어사전 엑셀 등록</strong></h1></div>				
				<div id="datail_table">
					<table>
						<tr>
							<th scope="row"><span class="th_add">행정용어사전 Excel 파일</span></th>
							<td>
								<input type="file" name="fileNm" title="파일선택"/>
								<font color="red">※ "EgovStandardTermStatus.xls" 파일만 업로드 가능합니다.</font> 
							</td>
						</tr>
					</table>
				</div>
				<div class="subbtn_align"> 
				    <ul>
				        ...
				        <li class="btn02_middlebg"><a href="<c:url value='/cms/cmm/addDicGovTermExcelOK.do'/>" onclick="fn_egov_save();return false;" class="btn_link">저장</a></li>
