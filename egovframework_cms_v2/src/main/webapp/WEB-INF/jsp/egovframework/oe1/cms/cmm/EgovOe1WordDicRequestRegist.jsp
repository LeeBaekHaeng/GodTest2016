...
<%
  /**
  * @JSP Name : EgovOe1WordDicRequestRegist.jsp
  * @Description : 용어사전신청등록
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="wordDicRequestInfo" name="wordDicRequestInfo" action="${pageContext.request.contextPath}/cms/metadata/req/insertWordDicRequestInfo.do" method="post" >
			<input name="cmd"            type="hidden" value="<c:out value='save'/>"/>
			<input name="reqstProcessId" type="hidden" value="<c:out value='AUTOINIT'/>"/>
			<form:hidden path="applcntId"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>용어사전신청등록</strong></h1></div>
				
				<div id="datail_table">
				<table summary="용어사전ID,용어명,사용여부">
					<caption>용어사전신청등록</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
