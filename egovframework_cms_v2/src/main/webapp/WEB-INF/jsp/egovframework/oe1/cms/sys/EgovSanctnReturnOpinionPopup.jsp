...
<%
  /**
  * @JSP Name : EgovSanctnReturnOpinionPopup.jsp
  * @Description : 반려의견작성
...
function fn_egov_ok() {
	...
	window.opener.fn_egov_doSubmitReturn();
	window.close();
	}
}
</script>
...
<div id="wrap">
    <div id="container">
		<div id="content">
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>반려의견</strong></h1></div>
						<form:form commandName="consentVO" name="detailForm">								
						<div id="datail_table">		
							<table width="410" border="0" cellspacing="0" cellpadding="0" summary="반려의견입니다.">
									<caption>반려의견</caption>
									<tr>
										  <th>반려의견</th>
								  				  <td align="left" style="padding-right:5px; padding-left:5px;">
								  				  <textarea id="confmOpinion" name = "confmOpinion" onkeyup="contents_check(this, 200);" onkeypress="contents_check2()" rows="3" cols="80" cssStyle="width:600px;ime-mode:active" title="반려의견"/></textarea>
								  				  </td>
								  	</tr>
							</table>						
						</div>								
								...
								<ul>
								    ...
								    <li><span class="submit_btn01"><input type="submit" name="submit_btn" value="반려" class="submit_btn_input"  onclick="fn_egov_ok(); return false;" /></span></li>
