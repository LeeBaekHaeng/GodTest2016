...
<%
/**
 * @JSP Name : EgovOe1DomainClRequestDetail.jsp
 * @Description : 도메인분류신청상세조회
...
<div id="content_pop">
	<div id="h2_topnav"><h1><strong>도메인분류신청상세조회</strong></h1></div>
    ...
    <form id="Form" name="Form" action="<c:url value='/cms/metadata/req/selectDomainClRequestInfo.do'/>" method="post">
	...
	<ul>
		...
		<li class="btn02_middlebg"><a href="<c:url value='/cms/metadata/req/deleteDomainClRequestInfo.do'/>?reqstProcessId=<c:out value='${result.reqstProcessId}'/>&amp;reqstProcessSn=<c:out value='${result.reqstProcessSn}'/>" onclick="fn_egov_delete();return false;" class="btn_link">신청취소</a></li>
		<li class="btn02_rightbg"></li>
					
		<li class="btn02_leftbg"></li>
		<li class="btn02_middlebg"><a href="<c:url value='/cms/metadata/req/updateDomainClRequestInfoView.do'/>?reqstProcessId=<c:out value='${result.reqstProcessId}'/>&amp;reqstProcessSn=<c:out value='${result.reqstProcessSn}'/>" onclick="fn_egov_modify();return false;" class="btn_link">수정</a></li>
		<li class="btn02_rightbg"></li>
		</c:if>
		
		<li class="btn02_leftbg"></li>
		<li class="btn02_middlebg"><a href="<c:url value='/cms/metadata/req/selectDomainClRequestInfoList.do'/>" onclick="fn_egov_list();return false;" class="btn_link">목록</a></li>
		<li class="btn02_rightbg"></li>	
