...
<%
/**
 * @JSP Name : EgovOe1DomainRegist.jsp
 * @Description : 도메인등록
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="domainInfo" name="domainInfo" action="${pageContext.request.contextPath}/cms/metadata/admin/insertDomainInfo.do" method="post" >
			<input name="cmd"      type="hidden" value="<c:out value='Regist'/>"/>
			<input name="domnId" type="hidden" value="<c:out value='AUTOINIT'/>"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>도메인등록</strong></h1></div>
				
				<div id="datail_table">
				<table summary="도메인ID,도메인명,사용여부">
					<caption>도메인등록</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
