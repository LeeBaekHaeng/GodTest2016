...
<%
  /**
  * @JSP Name : EgovOe1WordDicHistPopup.jsp
  * @Description : 용어사전이력조회팝업
...
<div id="content_pop">
	<div id="h2_topnav"><h1><strong>용어사전이력상세조회</strong></h1></div>
	...
	<table  summary="코드ID명,코드,코드명,코드설명,사용여부   입니다.">
		...
		<tr>
			...
			<td>
				<c:out value="${result.wordDicarySn}"/>
			</td>
		</tr>
		<tr>
