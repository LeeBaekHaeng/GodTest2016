...
<script type="text/javascript">
	...
	function fn_egov_regist_notice() {
		...
		if(confirm('<spring:message code="common.save.msg" />'))  {
			...
			document.board.action = "<c:url value='/cms/cmm/insertBoardArticle.do'/>";
			document.board.submit();					
		}
	}
	
	function fn_egov_select_noticeList() {
		document.board.action = "<c:url value='/cms/cmm/selectBoardList.do'/>";
		document.board.submit();	
	}	
</script>
...
<input type="hidden" name="authFlag" value="<c:out value='${bdMstr.authFlag}'/>" />
	...
	<div id="content_pop">
		...
		<div id="h2_topnav">
			<h1><strong><c:out value='${bdMstr.bbsNm}'/> - 게시글쓰기</strong></h1>
		</div>
		...
		<caption>게시글쓰기 테이블</caption>
		  ...
		  <tr> 
		    ...
		    <td colspan="3">
		      <input name="nttSj" type="text" size="80" maxlength="120" title="제목" /> 
		      <br><form:errors path="nttSj" />
		      
		    </td>
		  </tr>
		  <tr> 
		    <th scope="row" width="20%"><span class="th_add"><label for="nttCn">내용</label></span></th>
		    <td colspan="3">
		  ...
		  <tr>
		    <th scope="row" width="20%"><label for="egovComFileUploader">첨부파일</label></th>
		    <td colspan="3">
	            <div id="temp">
