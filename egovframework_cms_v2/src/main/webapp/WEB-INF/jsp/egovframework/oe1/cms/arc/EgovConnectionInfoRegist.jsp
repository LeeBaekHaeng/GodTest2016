...
<%
/**
 * @JSP Name : EgovConnectionInfoRegist.jsp
 * @Description : 연계정보 등록
...
function fn_egov_save() {	
	...
	if(!validateEgovOe1ConnectionInfoVO(frm)){
    	...
    	if(frm.cntcBeginDe.value > frm.cntcEndDe.value)
    		alert("시작일보다 종료일이 빠를 수 없습니다.");
    	else{
	        if(confirm('<spring:message code="common.save.msg" />')){
				document.egovOe1ConnectionInfoVO.action = "<c:url value='/cms/arc/insertConnectionInfo.do' />";
				document.egovOe1ConnectionInfoVO.submit();
	        }
    	}
    }
...
<form:form commandName="vo" name="egovOe1ConnectionInfoVO" action="/oe1/cms/arc/insertConnectionInfo.do">

<div id="content_pop">
<div id="h2_topnav"><h1><strong> 연계정보 등록</strong></h1></div>
<div id="datail_table">
<table summary="연계정보 항목을 등록합니다.">
<caption>연계정보 등록</caption>
	<colgroup>
		<col width="150">
		<col width="">
	</colgroup>
	<tr>
		...
		<td >
			<form:input path="cntcNm"  id="cntcNm" size="50" maxlength="80" cssClass="inputsmall01" title="연계명"/>
	...
	<tr>
		...
		<td >
			<form:input path="provdInstt"  id="provdInstt" size="50" maxlength="80" cssClass="inputsmall01" title="제공기관"/>
	...
	<tr>
		...
		<td>
			<form:input path="cttpc"  id="cttpc" size="30" maxlength="20" cssClass="inputsmall01" title="연락처"/>
	...
	<tr>
		...
		<td >
			<form:input path="cntcInfoDc"  id="cntcInfoDc" maxlength="500" cssClass="inputsmall01" title="연계설명"/>
...
<ul >
    ...
    <li class="btn02_middlebg"><a href="<c:url value='/cms/arc/insertConnectionInfoView.do'/>" class="btn_link"  onclick="document.insertForm.reset(); return false;"><span>초기화</span></a></li>
