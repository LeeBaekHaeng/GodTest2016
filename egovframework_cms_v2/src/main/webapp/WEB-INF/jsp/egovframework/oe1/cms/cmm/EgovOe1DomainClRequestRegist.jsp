...
<%
  /**
  * @JSP Name : EgovOe1DomainClRequestRegist.jsp
  * @Description : 도메인분류신청등록
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="domainClassRequestInfo" name="domainClassRequestInfo" action="${pageContext.request.contextPath}/cms/metadata/req/insertDomainClRequestInfo.do" method="post" >
			<input name="cmd"            type="hidden" value="<c:out value='save'/>"/>
			<input name="reqstProcessId" type="hidden" value="<c:out value='AUTOINIT'/>"/>
			<form:hidden path="applcntId"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>도메인분류신청등록</strong></h1></div>
				
				<div id="datail_table">
				<table summary="도메인분류ID,도메인분류명,사용여부">
					<caption>도메인분류신청등록</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
