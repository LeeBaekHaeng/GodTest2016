...
<%
  /**
  * @JSP Name : EgovResveMtgUpdt.jsp
  * @Description : 회의실예약 수정 화면
...
function fn_egov_save(){
   ...
   if(chkEmpty(frm.mtgNm.value)){
    ...
    if(confirm('일정을 수정하시겠습니까?')){
    	document.resvemtgForm.action = "<c:url value='/cms/mrm/updateResveMtgOK.do'/>";
    	document.resvemtgForm.submit();
    }else{
    	return;
    }
...
function fn_roomCheck(gb){
	...
	var val = window.open("<c:url value='/cms/mrm/selectDupCheckUpdate.do'/>?insRepeat="+frm.insRepeat.value+"&insRepeatCnt="+frm.insRepeatCnt.value+"&insRepeatDate="+frm.insRepeatDate.value+"&startHh="+frm.startHh.value+"&startMm="+frm.startMm.value+"&finishHh="+frm.finishHh.value+"&finishMm="+frm.finishMm.value+"&mtgPlaceId="+frm.mtgPlaceId.value+"&selectedId="+frm.selectedId.value,
...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="content">
			...
			<input type="hidden" name="selectedId" 			value="<c:out value='${egovOe1ResveMtgVO.mtgRoomResId}'/>" />
			<input type="hidden" name="posblAtchFileNumber" value="<c:out value='${egovOe1ResveMtgVO.posblAtchFileNumber}'/>" />
			<input type="hidden" name="returnUrl" 			value="/oe1/cms/mrm/updateResveMtg.do" />			
			...
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong> 회의실예약 수정</strong></h1></div>
				...
				<table summary="일정구분,업무명,제목,반복구분,시간,장소,담당자,참석자,참석자(비사용자),회의내용,첨부파일 입니다" >
					...
					<tr>
						<th scope="row"><span class="th_add">시간</span></th>
						<td>
                        <span id="TRANS_FRM">
                            ...
                            <span id="S_DATE_SPN">
                                ...
                                <a href="#LINK" onClick="dupCheckNull(); fn_egov_NormalCalendar(document.resvemtgForm, document.resvemtgForm.mtgStartDate, document.resvemtgForm.mtgStartDate);" style="selector-dummy:expression(this.hideFocus=false);"><img src="/oe1/images/egovframework/oe1/cms/com/bu_icon_carlendar.gif" alt="달력" title="새창" ></a>
                            </span>

                            <span id="S_TIME_SPN">
                                <select name="startHh" id="startHh" style="width:40;" title="시" TABINDEX="6" onChange="dupCheckNull();">                                	
                                ...
                                <select name="startMm" id="startMm" style="width:40;"  title="분"  TABINDEX="7" onChange="dupCheckNull();">
                            ...
                            <span id="F_DATE_SPN">
                                <input name="mtgEndDate" id="mtgEndDate" type="text" style="width:70;" title="종료일자"  class="textarea5"  readonly="readonly" value="<c:out value='${egovOe1ResveMtgVO.mtgEndDate}'/>" TABINDEX="8" >
                                <a href="#LINK" onClick="dupCheckNull(); fn_egov_NormalCalendar(document.resvemtgForm, document.resvemtgForm.mtgEndDate, document.resvemtgForm.mtgEndDate);" style="selector-dummy:expression(this.hideFocus=false);"><img src="/oe1/images/egovframework/oe1/cms/com/bu_icon_carlendar.gif" alt="달력" title="새창" ></a>
                            </span>

                            <span id="F_TIME_SPN">
                                <select name="finishHh" id="finishHh" style="width:40;" title="시" TABINDEX="9" onChange="dupCheckNull();">
                                ...
                                <select name="finishMm" id="finishMm" style="width:40;" title="분" TABINDEX="10" onChange="dupCheckNull();">
					...
					<tr>
						...
						<td>
							<select name="mtgPlaceId" id="mtgPlaceId" tabindex="11" title="장소"  class="opselect_smaill01" onChange="dupCheckNull();">
							...
							<input type="button" value="예약중복체크" onClick="dupCheckNull();fn_roomCheck('1');" title="새창">
					...
					<tr>
						...
						<td>
								...
								<input type="button" value="담당자선택" onclick="fn_egov_addDrafter()" name="B1"  title="새창">
					...
					<tr>
						...
						<td>
							<SELECT name="mtgRoomRes" id="mtgRoomRes" title="참석자" tabindex="13"   multiple="multiple">
							  <c:forEach items="${resultList}" var="codeInfo" varStatus="status">
							  <option value='${codeInfo.mtgAttenId}'>${codeInfo.mtgAttenName}</option>
							  </c:forEach>							
							</SELECT>
							<input type="button" value="추가" onclick="fn_egov_addDrafterMulti()" name="B1"  title="새창">
					...
					<tr>
						...
						<td>
							<form:input path="mtgAttenInfo" maxlength="200" title="참석자(비사용자)" tabindex="14" cssClass="opselect_smaill01"/>
				  ...
				  <c:if test="${not empty egovOe1ResveMtgVO.atchFileId}">
				  	...
				  	<!-- 2010.11.18 	
				  	<c:if test="${empty egovOe1ResveMtgVO.atchFileId}">
...
<script type="text/javascript">
	function a(){
		var existFileNum = document.resvemtgForm.fileListCnt.value;	    
