...
<%
  /**
  * @JSP Name : EgovMtgRmRegist.jsp
  * @Description : 회의실 Register 화면
...
function fn_egov_save() {	
	...
	if(!validateMtgrmForm(frm)){
    	...
    	if(confirm("저장 하시겠습니까?")){
    		document.mtgrmForm.action = "<c:url value='/cms/mrm/addMtgRmOK.do'/>";
    		document.mtgrmForm.submit();
    	}	
    }
...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="content">
			...
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong> 회의실 등록</strong></h1></div>
				...
				<table summary="회의실명,입장가능 인원,관리자,회의실 설명,사용여부 입니다" >
					...
					<tr>
						...
						<td>
							<form:input path="mtgAtndncNmpr" maxlength="100" tabindex="3" cssClass="opselect_smaill01" title="입장가능인원"/>
							&nbsp;<form:errors path="mtgAtndncNmpr" />

							<input type="hidden" name="mngrId" value="" >
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<form:input path="mngrNm" maxlength="20" tabindex="3" title="관리자" cssClass="opselect_smaill01" readonly="true"/>
				...
				<div class="subbtn_align"> 
				    <ul>
				        ...
				        <li class="btn02_leftbg"></li>
				        <li class="btn02_middlebg"><a href="<c:url value='/cms/mrm/selectDicGovTermList.do'/>" onclick="fn_egov_selectList();return false;" class="btn_link">목록</a></li>
				        <li class="btn02_rightbg"></li>				        			        
				    </ul>
				</div>				  	
			</div>
