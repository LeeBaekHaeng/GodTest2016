...
<%
/**
 * @JSP Name : EgovOe1WordDicRequestDetail.jsp
 * @Description : 용어사전신청상세조회
...
function fn_egov_modify(){
	var varForm				 = document.getElementById("Form");
	varForm.action           = "<c:url value='/cms/metadata/req/updateWordDicRequestInfoView.do'/>";
...
function fn_egov_delete(){
	if (confirm("<spring:message code='common.requestcancel.msg'/>")) {
		var varForm				 = document.getElementById("Form");
		varForm.action           = "<c:url value='/cms/metadata/req/deleteWordDicRequestInfo.do'/>";
	 	varForm.reqstProcessId.value   = "<c:out value='${result.reqstProcessId}'/>";
	 	varForm.reqstProcessSn.value   = "<c:out value='${result.reqstProcessSn}'/>";
		varForm.target           = "";
		varForm.submit();
...
<div id="content_pop">
	<div id="h2_topnav"><h1><strong>용어사전신청상세조회</strong></h1></div>
    ...
    <form id="Form" name="Form" action="<c:url value='/cms/metadata/req/selectWordDicRequestInfo.do'/>" method="post">
	...
	<ul>
		...
		<li class="btn02_middlebg"><a href="<c:url value='/cms/metadata/req/deleteWordDicRequestInfo.do'/>?reqstProcessId=<c:out value='${result.reqstProcessId}'/>&amp;reqstProcessSn=<c:out value='${result.reqstProcessSn}'/>" onclick="fn_egov_delete();return false;" class="btn_link">신청취소</a></li>
		<li class="btn02_rightbg"></li>
					
		<li class="btn02_leftbg"></li>
		<li class="btn02_middlebg"><a href="<c:url value='/cms/metadata/req/updateWordDicRequestInfoView.do'/>?reqstProcessId=<c:out value='${result.reqstProcessId}'/>&amp;reqstProcessSn=<c:out value='${result.reqstProcessSn}'/>" onclick="fn_egov_modify();return false;" class="btn_link">수정</a></li>
		<li class="btn02_rightbg"></li>
		</c:if>
		
		<li class="btn02_leftbg"></li>
		<li class="btn02_middlebg"><a href="<c:url value='/cms/metadata/req/selectWordDicRequestInfoList.do'/>" onclick="fn_egov_list();return false;" class="btn_link">목록</a></li>
		<li class="btn02_rightbg"></li>	
