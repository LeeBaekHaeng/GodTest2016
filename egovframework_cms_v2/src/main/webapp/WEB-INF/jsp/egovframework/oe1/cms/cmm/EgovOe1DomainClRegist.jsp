...
<%
  /**
  * @JSP Name : EgovOe1DomainClRegist.jsp
  * @Description : 도메인분류등록
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="domainClassInfo" name="domainClassInfo" action="${pageContext.request.contextPath}/cms/metadata/admin/insertDomainClInfo.do" method="post" >
			<input name="cmd"      type="hidden" value="<c:out value='Regist'/>"/>
			<input name="domnClId" type="hidden" value="<c:out value='AUTOINIT'/>"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>도메인분류등록</strong></h1></div>
				
				<div id="datail_table">
				<table summary="도메인분류ID,도메인분류명,사용여부">
					<caption>도메인분류등록</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
