...
function fn_egov_link_page(pageNo){
	...
	document.listForm.action = "<c:url value='/cms/mrm/inquiryGeneralMemberListPopup.do'/>";
   	document.listForm.submit();
}
function fn_egov_select(mngrId, mngrNm) {
	window.opener.document.mtgrmForm.mngrId.value = mngrId;
	window.opener.document.mtgrmForm.mngrNm.value = mngrNm;
	window.close();
}
