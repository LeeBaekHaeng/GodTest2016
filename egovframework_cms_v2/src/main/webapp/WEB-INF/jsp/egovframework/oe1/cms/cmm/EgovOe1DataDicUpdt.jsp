...
<%
  /**
  * @JSP Name : EgovOe1DataDicUpdt.jsp
  * @Description : 자료사전수정
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="dataDic" name="dataDic" action="${pageContext.request.contextPath}/cms/metadata/admin/updateDataDic.do" method="post" >
			<input name="dtaDicaryId" type="hidden" value="<c:out value='${dataDic.dtaDicaryId}'/>"/>
			<input name="useAt" type="hidden" value="<c:out value='${dataDic.useAt}'/>"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>자료사전수정</strong></h1></div>
				
				<div id="datail_table">
				<table summary="자료사전ID,자료사전명,사용여부">
					<caption>자료사전수정</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
					...
					<tr>
						...
						<td>
							<c:out value='${dataDic.dtaDicaryId}'/>
						</td>
					</tr>
					<tr>
						<th scope="row"><span class="th_add"><label for="dtaDicaryNm">자료사전명</label></span></th>
						<td>
							<input type="text" id="dtaDicaryNm" name="dtaDicaryNm" readonly="readonly" size="60" maxlength="60" class="inputsmall02" value="<c:out value='${dataDic.dtaDicaryNm}'/>" title="자료사전명"/>
					...
					<tr>
						...
						<td>
							<input type="text" id="dtaDicaryEngNm" name="dtaDicaryEngNm" readonly="readonly" size="60" maxlength="60" class="inputsmall02" style="float:left;" value="<c:out value='${dataDic.dtaDicaryEngNm}'/>" title="자료사전영문명"/>
					...
					<tr>
						...
						<td>
							<input type="text" name="domnNm" readonly="readonly" size="60" maxlength="60" class="inputsmall02" value="<c:out value='${dataDic.domnNm}'/>" title="도메인명"/>
					...
					<tr>
						...
						<td>
							<input type="text" name="dataTy" readonly="readonly" size="60" maxlength="60" class="inputsmall02" value="<c:out value='${dataDic.dataTy}'/>" title="데이터유형"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="dataLt">데이터길이</label></th>
						<td>
							<input type="text" name="dataLt" readonly="readonly" size="60" maxlength="60" class="inputsmall02" value="<c:out value='${dataDic.dataLt}'/>" title="데이터길이"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="useAt">사용여부</label></th>
						<td>	
							<c:if test="${dataDic.useAt == 'Y'}">사용</c:if>
							<c:if test="${dataDic.useAt == 'N'}">미사용</c:if>		
						</td>
					</tr>
					<tr>
