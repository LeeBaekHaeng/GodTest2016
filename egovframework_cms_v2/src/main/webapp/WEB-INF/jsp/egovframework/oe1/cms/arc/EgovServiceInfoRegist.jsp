...
<%
  /**
  * @JSP Name : EgovServiceInfoRegist.jsp
  * @Description : Service Information Register 화면
...
function fn_egov_save() {	
	...
	if(!validateEgovOe1ServiceInfoVO(frm)){
		...
		if(confirm('<spring:message code="common.save.msg" />')){
			document.egovOe1ServiceInfoVO.action = "<c:url value='/cms/arc/insertServiceInfo.do' />";
			document.egovOe1ServiceInfoVO.submit();
			}
		}
}
...
<form:form commandName="vo" name="egovOe1ServiceInfoVO" action="/oe1/cms/arc/insertServiceInfo.do">

<div id="content_pop">
<div id="h2_topnav"><h1><strong> 서비스정보 등록</strong></h1></div>
<div id="datail_table">
<table summary="서비스정보를 등록합니다.">
<caption>서비스정보 등록</caption>
	<colgroup>
		<col width="150">
		<col width="">
	</colgroup>
...
<ul >
    ...
    <li class="btn02_middlebg"><a href="<c:url value='/cms/arc/insertServiceInfoView.do'/>" class="btn_link"  onclick="document.insertForm.reset(); return false;"><span>초기화</span></a></li>
