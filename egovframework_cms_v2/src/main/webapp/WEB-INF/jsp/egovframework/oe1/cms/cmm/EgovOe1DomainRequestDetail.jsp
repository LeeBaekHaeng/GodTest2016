...
<%
/**
 * @JSP Name : EgovOe1DomainRequestDetail.jsp
 * @Description : 도메인신청상세조회
...
function fn_egov_modify(){
	var varForm				 = document.getElementById("Form");
	varForm.action           = "<c:url value='/cms/metadata/req/updateDomainRequestInfoView.do'/>";
...
function fn_egov_delete(){
	if (confirm("<spring:message code='common.requestcancel.msg'/>")) {
		var varForm				 = document.getElementById("Form");
		varForm.action           = "<c:url value='/cms/metadata/req/deleteDomainRequestInfo.do'/>";
	 	varForm.reqstProcessId.value   = "<c:out value='${result.reqstProcessId}'/>";
	 	varForm.reqstProcessSn.value   = "<c:out value='${result.reqstProcessSn}'/>";
		varForm.target           = "";
		varForm.submit();
...
<div id="content_pop">
	<div id="h2_topnav"><h1><strong>도메인신청상세조회</strong></h1></div>
	
	<div id="datail_table">
	<table  summary="코드ID명,코드,코드명,코드설명,사용여부   입니다.">
		<caption>도메인신청상세</caption>
		<colgroup>
			<col width="150">
			<col width="">
		</colgroup>
    ...
    <form id="Form" name="Form" action="<c:url value='/cms/metadata/req/insertDomainRequestInfo.do'/>" method="post">
	...
	<ul>
		...
		<li class="btn02_middlebg"><a href="<c:url value='/cms/metadata/req/deleteDomainRequestInfo.do'/>?reqstProcessId=<c:out value='${result.reqstProcessId}'/>&amp;reqstProcessSn=<c:out value='${result.reqstProcessSn}'/>" onclick="fn_egov_delete();return false;" class="btn_link">신청취소</a></li>
		<li class="btn02_rightbg"></li>
					
		<li class="btn02_leftbg"></li>
		<li class="btn02_middlebg"><a href="<c:url value='/cms/metadata/req/updateDomainRequestInfoView.do'/>?reqstProcessId=<c:out value='${result.reqstProcessId}'/>&amp;reqstProcessSn=<c:out value='${result.reqstProcessSn}'/>" onclick="fn_egov_modify();return false;" class="btn_link">수정</a></li>
		<li class="btn02_rightbg"></li>
		</c:if>
