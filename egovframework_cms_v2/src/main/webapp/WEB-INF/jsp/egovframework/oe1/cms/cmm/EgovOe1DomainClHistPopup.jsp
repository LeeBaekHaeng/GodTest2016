...
<%
  /**
  * @JSP Name : EgovOe1DomainClHistPopup.jsp
  * @Description : 도메인분류이력조회팝업
...
<div id="content_pop">
	<div id="h2_topnav"><h1><strong>도메인분류이력상세조회</strong></h1></div>
