...
<%
  /**
   * @JSP Name : EgovParameterDetail.jsp
   * @Description : 파라메터 상세정보
...
<input type="hidden" name="id" value="<c:out value='${vo.paramtrId}' />" />
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="h2_topnav"><h1><strong> 파라메터 상세정보</strong></h1></div>
	<!-- // 타이틀 -->
	<div id="datail_table">
	<table summary="파라메터 상세정보">
	<caption>파라메터 상세정보</caption>
		<tr>
			<th>리턴타입</th>
			<td>
				<c:out value='${vo.paramtrTy}' />
			</td>
		</tr>
		<tr>
			<th>파라메터명</th>
			<td>
				<c:out value='${vo.paramtrNm}' />
			</td>
		</tr>
		<tr>
			<th>파라메터 설명</th>
			<td>
				<pre><c:out value='${vo.paramtrDc}' /></pre>
			</td>
		</tr>
	</table>
  </div>
