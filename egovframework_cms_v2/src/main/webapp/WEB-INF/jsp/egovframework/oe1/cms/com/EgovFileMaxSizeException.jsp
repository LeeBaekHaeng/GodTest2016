...
<%
  /**
  * @JSP Name : EgovFileMaxSizeException.jsp
  * @Description : 파일사이즈 초과
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    ...
                    <td width="399" align="left" class="board_title">파일사이즈 초과</td>
                  </tr>
                  <tr>
                    <td align="left" valign="top" class="board_content">
                    	첨부파일의 최대 사이즈는 [ 
                    	<fmt:formatNumber value="${(fn:replace(fn:split(exception.message,'(')[2],')','')/1024)/1024}" maxFractionDigits="2"/>
                    	MB ] 입니다.
                    	<!-- ${fn:split(fn:split(exception.message,"(")[1],")")[0]}  업로드파일 사이즈-->
					</td>
                  </tr>
                </table>
        	 </td>
