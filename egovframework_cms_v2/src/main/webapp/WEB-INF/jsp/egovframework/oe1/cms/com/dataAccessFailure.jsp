        ...
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    ...
                    <td width="399" align="left" class="board_title">[ 데이터 액세스 실패 ] 오류가 발생하였습니다.</td>
                  </tr>
                </table>
        	 </td>
              </tr>
              ...
              <tr>
                <!--<td align="center"><a href="/oe1/cms/com/viewMainPage.do"><img src="<c:url value='/images/egovframework/oe1/cms/er_images/go_main.jpg' />" alt="첫화면으로" border="0" /></a></td>-->
