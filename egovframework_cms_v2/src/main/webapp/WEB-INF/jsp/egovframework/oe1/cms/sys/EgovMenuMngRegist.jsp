...
<%
  /**
  * @JSP Name : EgovMenuMngRegist.jsp
  * @Description : 메뉴 정보 등록 화면
...
function fn_save(){
	...
	if(!validateMenuMngVO(frm)){
    	...
    	frm.action ="<c:url value='/cms/sys/EgovOe1MenuMngRegist.do'/>";
        frm.submit();
    	}
    }
}
...
function fn_reset(){
	document.regist_form.action ="<c:url value='/cms/sys/EgovOe1MenuMngRegistView.do'/>";
	document.regist_form.submit();
}

function fn_selectList(){
	document.regist_form.action = "<c:url value='/cms/sys/EgovOe1SelectMenuMngList.do'/>";
	document.regist_form.submit();
}
</script>
<!-- 업무 scrpit END -->
...
<div id="wrap">
    ...
    <div id="container">
		...
		<!-- BODY 내용 START -->
						...
						<!-- form 시작 -->
						<form:form commandName="menuMngVO" name="regist_form" method="post">
						
							<!-- content_pop 시작 -->	
							<div id="content_pop">
						<!-- 타이틀 -->
						<div id="h2_topnav">
						<h1><strong>메뉴정보 등록</strong></h1>
						</div>
						<!-- // 타이틀 -->
								
								<!-- 목록 시작 -->
								<div id=datail_table>
									<table summary="메뉴정보등록">
										<caption>메뉴정보등록</caption>

										<tr>
											<th scope="row"><span class="th_add" /><label for="menuNm">메뉴명</label></span></th>
											<td>
												<form:input path="menuNm" maxlength="30" cssClass="inputsmall01" title="메뉴명"/>
										...
										<tr>
											...
											<td>
												<form:input path="menuDc" maxlength="30" cssClass="inputsmall01" title="메뉴설명"/>
												&nbsp;<form:errors path="menuDc" />
											</td>
										</tr>

										<tr>
											<th scope="row"><label for="menuOrdr">메뉴순서</label></th>
											<td>
