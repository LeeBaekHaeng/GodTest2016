...
<%
  /**
  * @JSP Name : EgovDicTermExcelRegist.jsp
  * @Description : 용어사전 엑셀 Register 화면
...
function fn_egov_addExcelDown(){
   	document.dictermForm.action = "<c:url value='/cms/cmm/addDicTermExcelTempletDwon.do'/>";
   	document.dictermForm.submit();	
}
...
function fn_egov_save(){
    ...
    if(confirm("기존 등록된 내용이 삭제 된 후 저장됩니다. \n계속 진행 하시겠습니까?")){
    	document.dictermForm.action =  "<c:url value = '/cms/cmm/addDicTermExcelOK.do'/>";
    	document.dictermForm.submit();
    }
}
*/
	...
	if(frm.fileNm.value==""){
    	...
    	if(fnImg_Check(frm.fileNm.value)){
        	if(confirm("기존 등록된 자료를 삭제후  파일을 등록합니다. \n엑셀 일괄등록을 하시겠습니까?  \n\n시간이 오래 걸릴 수 있습니다.")){
        		frm.action = "<c:url value='/cms/cmm/addDicTermExcelOK.do'/>";
        		frm.submit();
    		}            	
    	}    	            	
    }
...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="content"><!-- BODY 내용 START -->
			...
			<form:form commandName="egovOe1DicTermVO" name="dictermForm" action="/cms/cmm/addDicTermExcelOK.do" method="post" enctype="multipart/form-data" >
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong> 용어사전 엑셀 등록</strong></h1></div>
				...
				<table>
					...
					<tr>
						<th scope="row"><span class="th_add">용어사전 Excel 파일</span></th>
						<td>
							<input type="file" name="fileNm" title="파일선택"/><br>
							<font color="red">※ "StandardTermStatus.xls" 파일만 업로드 가능합니다.</font><br>
							<font color="red">※ 엑셀Templet을 다운로드 받은 후 용어사전을 작성 후 Upload 하세요.</font>
						</td>
					</tr>
				</table>
				</div>
				<div class="subbtn_align"> 
				    <ul>
				        ...
				        <li class="btn02_middlebg"><a href="<c:url value='/cms/cmm/addDicTermExcelOK.do'/>" onclick="fn_egov_save();return false;" class="btn_link">저장</a></li>
				        ...
				        <li class="btn02_rightbg"></li>
						<li class="btn02_leftbg"></li>
						<li class="btn02_middlebg"><a href="<c:url value='/cms/cmm/addDicTermExcelTempletDwon.do'/>" onclick="fn_egov_addExcelDown(); return false;" class="btn_link">엑셀Templet다운로드</a></li>
						<li class="btn02_rightbg"></li>					        
				    </ul>
				</div>						
			</div>
