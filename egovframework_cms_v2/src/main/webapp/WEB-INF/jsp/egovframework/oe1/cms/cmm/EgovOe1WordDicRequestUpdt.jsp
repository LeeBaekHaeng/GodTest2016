...
<%
/**
 * @JSP Name : EgovOe1WordDicRequestUpdt.jsp
 * @Description : 용어사전신청수정
...
<validator:javascript formName="wordDicRequestInfo" staticJavascript="false" xhtml="true" cdata="false"/>
...
function fn_egov_list(){
	var varForm				 = document.getElementById("wordDicRequestInfo");
...
function fn_egov_save(cmd){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		if(!validateWordDicRequestInfo(varForm)){ 			
			return;
		}else{
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="wordDicRequestInfo" name="wordDicRequestInfo" action="${pageContext.request.contextPath}/cms/metadata/req/updateWordDicRequestInfo.do" method="post" >
			<input name="cmd"            type="hidden" value="<c:out value='save'/>"/>
			<form:hidden path="reqstProcessId"/>
			<form:hidden path="reqstProcessSn"/>
			<form:hidden path="applcntId"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>용어사전신청수정</strong></h1></div>
				
				<div id="datail_table">
				<table summary="용어사전ID,용어명,사용여부">
					<caption>용어사전신청수정</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
					...
					<tr>
						...
						<td>
							<c:out value="${wordDicRequestInfo.reqstProcessId}"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="reqstProcessSn">신청처리순번</label></th>
						<td>
							<c:out value="${wordDicRequestInfo.reqstProcessSn}"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="applcntId">신청인</label></th>
						<td>
							<c:out value="${wordDicRequestInfo.applcntNm}"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row"><span class="th_add"><label for="wordDicId">용어영문약어명</label></span></th>
						<td>
