...
<%
  /**
  * @JSP Name : EgovCrdnDetail.jsp
  * @Description : 유관기관 상세정보
...
function fn_egov_save() {
	...
	if(!validateCrdnVO(frm)){
		...
		if(confirm("저장하시겠습니까?")){
        	frm.action = "<c:url value='/cms/com/updtCrdn.do'/>";
        	frm.submit();
		}
    }
}
...
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="h2_topnav"><h1><strong> 유관기관 상세정보</strong></h1></div>
	<!-- // 타이틀 -->
	<div id="datail_table">
	<table summary="기관ID,기관명,주소,전화번호,팩스번호 입니다.">
	<caption>유관기관 상세정보</caption>
		<tr>
			<th scope="row" width="20%"><span class="th_add"><label for="crdnsId">기관ID</label></span></th>
			<td>
				<form:input path="crdnsId" cssClass="inputsmall_readOnly" maxlength="10" readonly="true" title="기관ID"/>
			</td>			
		</tr>
		<tr>
			<th scope="row" width="20%"><span class="th_add"><label for="crdnsNm">기관명</label></span></th>
			<td>
				<form:input path="crdnsNm" size="20" maxlength="20" cssClass="inputsmall" readonly="true" title="기관명"/>
		...
		<tr>
			...
			<td>
				...
				&nbsp;<form:errors path="crdnsTelNo" /></td>
		</tr>
		<tr>
