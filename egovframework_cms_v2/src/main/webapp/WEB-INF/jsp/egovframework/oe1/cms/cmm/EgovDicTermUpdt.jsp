...
<%
  /**
  * @JSP Name : EgovDicTermUpdt.jsp
  * @Description : 용어사전 수정 화면
...
function fn_egov_save() {	
	...
	document.dictermForm.selectedId.value = frm.selectedId.value;
	
	if(!validateDictermForm(frm)){
        return;
    }else{    	
    	if(confirm("저장하시겠습니까?")){
    		document.dictermForm.action = "<c:url value='/cms/cmm/updateDicTermOK.do'/>";
    		document.dictermForm.submit();
    	}	
    }
...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="content"><!-- BODY 내용 START -->
			...
			<input type="hidden" name="selectedId" value="<c:out value="${egovOe1DicTermVO.wordId}"/>"/>
			<div id="content_pop">
				<!-- 타이틀 -->
				<div id="h2_topnav"><h1><strong>용어사전 수정</strong></h1></div>
				<!-- // 타이틀 -->
				<div id="datail_table">
				<table summary="용어명,동의어,영문명,영문약어,용어 설명,사용여부 입니다" >
					...
					<tr>
						...
						<td>
							<form:input path="wordNm" maxlength="60" tabindex="2"  cssClass="inputsmall01" title="용어명" readonly="true"/>
					...
					<tr>
						...
						<td>
							<form:input path="synonm" maxlength="100" tabindex="3"  cssClass="inputsmall01" title="동의어"/>
					...
					<tr>
						...
						<td>
							<form:input path="engNm" maxlength="60" tabindex="4"  cssClass="inputsmall01" title="영문명" readonly="true"/>
					...
					<tr>
						...
						<td>
							<form:input path="wordNmEngAbrv" maxlength="60" tabindex="5"  cssClass="inputsmall01" title="영문약어" readonly="true"/>
							&nbsp;<form:errors path="wordNmEngAbrv" />
						</td>
					</tr>	
					<tr>
						<th scope="row"><span class="th_add"><label for="wordDc">용어 설명</label></span></th>
						<td>
