...
function fn_egov_delete() {
	if(confirm('<spring:message code="common.delete.msg" />')) {
	   	document.msgManage.action = "<c:url value='/cms/arc/deleteMsg.do'/>";
	   	document.msgManage.submit();
	}	
}
...
function fn_egov_save() {	
	...
	if(!validateMsgManage(frm)){
		...
		if(confirm('<spring:message code="common.save.msg" />'))  {
	    	frm.action = "<c:url value='/cms/arc/upateMsgList.do'/>";
	        frm.submit();
		}
	}
}
...
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="h2_topnav"><h1><strong> 메시지  상세정보</strong></h1></div>
	<!-- // 타이틀 -->
	<div id="datail_table">
	<table summary="메시지  상세정보" class="table_style" id="tableId1">
	<caption>메시지 상세정보</caption>
	<colgroup>
		<col width="200">
		<col width="">
	</colgroup>	
		<tr>
			...
			<td>
				<form:input path="mssageId" maxlength="30" cssClass="inputsmall_readOnly" readonly="true" title="메시지 ID" />
