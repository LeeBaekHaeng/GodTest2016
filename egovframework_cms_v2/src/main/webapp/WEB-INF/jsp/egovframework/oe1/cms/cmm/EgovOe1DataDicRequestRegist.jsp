...
<%
  /**
  * @JSP Name : EgovOe1DataDicRequestRegist.jsp
  * @Description : 자료사전신청등록
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- BODY 내용 START -->
			...
			<form:form commandName="dataDicRequestInfo" name="dataDicRequestInfo" action="${pageContext.request.contextPath}/cms/metadata/req/insertDataDicRequestInfo.do" method="post" >
			<input name="cmd"            type="hidden" value="<c:out value='save'/>"/>
			<input name="reqstProcessId" type="hidden" value="<c:out value='AUTOINIT'/>"/>
			<form:hidden path="applcntId"/>
			<div id="content_pop">
				<div id="h2_topnav"><h1><strong>자료사전신청등록</strong></h1></div>
				
				<div id="datail_table">
				<table summary="자료사전ID,자료명,사용여부">
					<caption>자료사전신청등록</caption>
					<colgroup>
						<col width="150">
						<col width="">
					</colgroup>
					...
					<tr>
						...
						<td>
							<input type="text" id="dtaDicaryEngNm" name="dtaDicaryEngNm" readonly="readonly" size="60" maxlength="60" class="inputsmall02" style="float:left;" title="자료사전영문명"/>
