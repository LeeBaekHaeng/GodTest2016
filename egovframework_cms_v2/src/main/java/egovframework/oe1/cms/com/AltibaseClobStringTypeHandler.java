...
/**
 * iBATIS TypeHandler implementation for Strings that
 * get mapped to CLOBs. Retrieves the LobHandler to use
 * from SqlMapClientFactoryBean at config time.
 * <p>
 * Particularly useful for storing Strings with more
 * than 4000 characters in an Oracle database (only
 * possible via CLOBs), in combination with
 * OracleLobHandler.
 * <p>
 * Can also be defined in generic iBATIS mappings, as
 * DefaultLobCreator will work with most JDBC-compliant
 * database drivers. In this case, the field type does
 * not have to be BLOB: For databases like MySQL and MS
 * SQL Server, any large enough binary type will work.
...
public class AltibaseClobStringTypeHandler extends AbstractLobTypeHandler {
    ...
    /**
     * Constructor used by iBATIS: fetches config-time
     * LobHandler from SqlMapClientFactoryBean.
    ...
    /**
     * Constructor used for testing: takes an explicit
     * LobHandler.
     */
    ...
    protected Object getResultInternal(ResultSet rs, int index,
        ...
        // return lobHandler.getClobAsString(rs,
        // index);
    }
