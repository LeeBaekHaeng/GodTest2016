 ...
 * </pre>
 */
public class EgovOe1LoginPolicyVO extends EgovOe1ComDefaultVO  {
	 ...
	 * 로그인 정책 목록
	 */
	private List<EgovOe1LoginPolicyVO> loginPolicyList;
	 ...
	 */
	public List<EgovOe1LoginPolicyVO> getLoginPolicyList() {
		return loginPolicyList;
	}
	/**
	 * @param loginPolicyList the loginPolicyList to set
	 */
	public void setLoginPolicyList(List<EgovOe1LoginPolicyVO> loginPolicyList) {
