...
import egovframework.oe1.cms.com.service.EgovOe1Globals;
import egovframework.oe1.cms.com.service.EgovOe1Properties;

/**
 * Class Name : EgovClntInfo.java Description :
 * 클라이언트(Client)의 IP주소, OS정보, 웹브라우저정보를 조회하는 Business
 * Interface class
...
public class EgovClntInfo {
    ...
    public static String getClntOsInfo(HttpServletRequest request)
        ...
        String os_conf =
            EgovOe1Properties.getProperty(EgovOe1Globals.clientConfPath, os_info
                .replaceAll(" ", ""));
        String osInfo = "";
    ...
    public static String getClntWebVer(HttpServletRequest request)
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            if (s_loc != -1) {
                ...
                webVer =
                    webVer.replaceAll("/", "").replaceAll(";", "").replaceAll(
