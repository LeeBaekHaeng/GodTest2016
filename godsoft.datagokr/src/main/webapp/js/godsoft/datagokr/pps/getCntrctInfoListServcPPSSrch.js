...
//					+ '&numOfRows=1000&pageSize=10&pageNo=1&startPage=1&inqryDiv=1&inqryBgnDate=20180101&inqryEndDate=20181231&cntrctNm=' + encodeURIComponent(encodeURIComponent('시스템')));
//	// var url = '../../../../proxy.jsp?'
//	// +
...
function fn_getCntrctInfoListServcPPSSrch2() {
	...
	var data = {
		...
		inqryBgnDate : '20180101',
		// inqryEndDate : '20171131',
		inqryEndDate : '20181231',
