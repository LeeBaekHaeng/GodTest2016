...
<td height="60">
    ...
    <td>
		...
		<td>
			...
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do' />?year=<%=year-1%>&amp;month=<%=month%>"><img src="<c:url value='/images/egovframework/com/cmm/icon/icoPrev.gif' />" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시"></a>
			<font size="3"><b><%=year%>년</b></font>
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do' />?year=<%=year+1%>&amp;month=<%=month%>"><img src="<c:url value='/images/egovframework/com/cmm/icon/icoNxt.gif' />" style="margin-left:4px;border:0px;" alt="다음으로가기아이콘표시"></a>
			</td>
			<td width="80" align="center">
			<%if(month > 0 ){ %>
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do' />?year=<%=year%>&amp;month=<%=month-1%>"><img src="<c:url value='/images/egovframework/com/cmm/icon/icoPrev.gif' />" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시"></a>
			<%}%>
			<font size="3"><b><%=month+1%>월</b></font>
			<%if(month < 11 ){ %>
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do' />?year=<%=year%>&amp;month=<%=month+1%>"><img src="<c:url value='/images/egovframework/com/cmm/icon/icoNxt.gif' />" style="margin-left:4px;border:0px;" alt="다음으로가기아이콘표시"></a>
			<%}%>
			</td>
			</tr>
			</table>
