...
<caption>당직체크 상세</caption>
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row">당직체크구분<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td><c:out value='${bndtCeckManageVO.bndtCeckTemp1}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">당직체크코드<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td><c:out value='${bndtCeckManageVO.bndtCeckCd}'/></td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text" scope="row">당직체크코드명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td><c:out value='${bndtCeckManageVO.bndtCeckCdNm}'/></td>    
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row">사용여부<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
