...
<%
 /**
  * @Class Name : Test20170604LbhEntrprsMberRegister.jsp
  * @Description : Test20170604LbhEntrprsMber Register 화면
...
<c:set var="registerFlag" value="${empty test20170604LbhEntrprsMberVO.entrprsMberId ? '등록' : '수정'}"/>
...
<!-- validator:javascript formName="test20170604LbhEntrprsMberVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/test20170604LbhEntrprsMber/Test20170604LbhEntrprsMberList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/test20170604LbhEntrprsMber/deleteTest20170604LbhEntrprsMber.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/test20170604LbhEntrprsMber/addTest20170604LbhEntrprsMber.do' : '/test20170604LbhEntrprsMber/updateTest20170604LbhEntrprsMber.do'}"/>";
    frm.submit();
...
<form:form commandName="test20170604LbhEntrprsMberVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
