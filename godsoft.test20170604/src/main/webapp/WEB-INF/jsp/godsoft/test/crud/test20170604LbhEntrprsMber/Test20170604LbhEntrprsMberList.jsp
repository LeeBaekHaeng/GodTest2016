...
<%
 /**
  * @Class Name : Test20170604LbhEntrprsMberList.jsp
  * @Description : Test20170604LbhEntrprsMber List 화면
...
function fn_egov_select(entrprsMberId) {
	document.getElementById("listForm").entrprsMberId.value = entrprsMberId;
   	document.getElementById("listForm").action = "<c:url value='/test20170604LbhEntrprsMber/updateTest20170604LbhEntrprsMberView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/test20170604LbhEntrprsMber/addTest20170604LbhEntrprsMberView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/test20170604LbhEntrprsMber/Test20170604LbhEntrprsMberList.do'/>";
   	document.getElementById("listForm").submit();
}
